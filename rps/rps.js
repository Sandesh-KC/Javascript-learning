...
document.querySelector('.js-move').innerHTML = ` You <img src="../RockPaperScissors/Assets/${playerMove}.png" class="game-move">
<img src="../RockPaperScissors/Assets/${computerMove}.png" class="game-move">Comp`;
}
